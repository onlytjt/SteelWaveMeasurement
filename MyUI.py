...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_image.setText(_translate("MainWindow", "图像显示区域400*300", None))
        ...
        self.label_canny.setText(_translate("MainWindow", "边缘显示区域800*600", None))
